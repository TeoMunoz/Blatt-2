!(function (t, n) {
  ...
  function o(t, r, e) {
    return function () {
      for (
        var u = [], c = 0, a = t, s = 0;
        r.length > s || arguments.length > c;
      ) {
        var f;
        (s >= r.length || (n(r[s]) && arguments.length > c)
          ? ((f = arguments[c]), (c += 1))
          : (f = r[s]),
          (u[s] = f),
          n(f) || (a -= 1),
  ...
  function b(t, n, r) {
    ...
    if ("function" == typeof r["fantasy-land/reduce"])
      return m(t, n, r, "fantasy-land/reduce");
  ...
  function S(t) {
    return function n(r) {
      for (var e, u, i, o = [], c = 0, a = r.length; a > c; ) {
        if (_t(r[c]))
          for (i = 0, u = (e = t ? n(r[c]) : r[c]).length; u > i; )
            ((o[o.length] = e[i]), (i += 1));
        else o[o.length] = r[c];
        c += 1;
      }
  ...
  function N(t, n) {
    return function () {
      ...
      if (0 === r) return n();
      var e = arguments[r - 1];
      return At(e) || "function" != typeof e[t]
        ? n.apply(this, arguments)
        : e[t].apply(e, Array.prototype.slice.call(arguments, 0, r - 1));
    };
  }
  function I() {
  ...
  function W() {
    if (0 === arguments.length)
      throw Error("compose requires at least one argument");
    return I.apply(this, Sn(arguments));
  }
  function P() {
    if (0 === arguments.length)
      throw Error("composeK requires at least one argument");
  ...
  function T() {
    if (0 === arguments.length)
      throw Error("pipeP requires at least one argument");
  ...
  function D(t, n, r, e) {
    ...
    switch (u) {
      case "Map":
        return (
          t.size === n.size &&
          U(t.entries(), n.entries(), r.concat([t]), e.concat([n]))
        );
      case "Set":
        return (
          t.size === n.size &&
          U(t.values(), n.values(), r.concat([t]), e.concat([n]))
        );
      case "Arguments":
      case "Array":
      case "Object":
        ...
        return 0 === t && 1 / t == -1 / 0
          ...
          : null !== r._nativeSet
            ? n
              ...
              : r._nativeSet.has(t)
            : u in r._items
              ? t in r._items[u] || (n && (r._items[u][t] = !0), !1)
              : (n && ((r._items[u] = {}), (r._items[u][t] = !0)), !1);
      case "boolean":
        if (u in r._items) {
          var i = t ? 1 : 0;
      ...
      case "function":
        return null !== r._nativeSet
          ? n
            ...
            : r._nativeSet.has(t)
          : u in r._items
            ? !!M(t, r._items[u]) || (n && r._items[u].push(t), !1)
            : (n && (r._items[u] = [t]), !1);
      case "undefined":
        return !!r._items[u] || (n && (r._items[u] = !0), !1);
      case "object":
        if (null === t)
          return !!r._items.null || (n && (r._items.null = !0), !1);
      default:
        return (u = Object.prototype.toString.call(t)) in r._items
          ? !!M(t, r._items[u]) || (n && r._items[u].push(t), !1)
          : (n && (r._items[u] = [t]), !1);
    }
  }
  ...
  ((l.prototype["@@transducer/init"] = Ot.init),
    ...
    (l.prototype["@@transducer/step"] = function (t, n) {
      return (
        this.f(n) ||
          ((this.all = !1), (t = f(this.xf["@@transducer/step"](t, !1)))),
        t
      );
    }));
  var St = e(
  ...
  ((x.prototype["@@transducer/init"] = Ot.init),
    (x.prototype["@@transducer/result"] = Ot.result),
  ...
  var Nt = e(function (t, n) {
    ...
    Wt = function () {
      return "[object Arguments]" === It.call(arguments)
        ? function (t) {
    ...
    Pt = !{ toString: null }.propertyIsEnumerable("toString"),
    Ct = [
      "constructor",
      "valueOf",
      "isPrototypeOf",
    ...
    Ft = r(
      "function" != typeof Object.keys || Tt
        ? function (t) {
            ...
            if (Pt)
              for (r = 6; r >= 0; )
                (w((n = Ct[r]), t) && !Bt(e, n) && (e[e.length] = n), (r -= 1));
            return e;
          }
        : function (t) {
    ...
    Rt = e(
      s(["fantasy-land/map", "map"], Nt, function (t, n) {
  ...
  ((j.prototype["@@transducer/init"] = Ot.init),
    ...
    (j.prototype["@@transducer/step"] = function (t, n) {
      return (
        this.f(n) &&
          ((this.any = !0), (t = f(this.xf["@@transducer/step"](t, !0)))),
        t
      );
    }));
  ...
  ((A.prototype["@@transducer/init"] = Ot.init),
  ...
  var Xt = e(
      s(
        ...
        function (t, n) {
          for (
            var r = 0, e = n.length - (t - 1), u = Array(0 > e ? 0 : e);
            e > r;
          )
    ...
    Gt = r(function (t) {
      for (var n = Ft(t), r = n.length, e = [], u = 0; r > u; )
        ((e[u] = t[n[u]]), (u += 1));
      return e;
    }),
    Qt = r(function t(n) {
      return (
        ...
        xt(Mt(Et, 0, zt("length", Gt(n))), function () {
          var t = arguments;
  ...
  ((H.prototype["@@transducer/init"] = Ot.init),
    (H.prototype["@@transducer/result"] = Ot.result),
    (H.prototype["@@transducer/step"] = function (t, n) {
  ...
  var Nn = e(
    ...
    Pn = e(function (t, n) {
      ...
      if (null != t && O(t["fantasy-land/concat"]))
        return t["fantasy-land/concat"](n);
      ...
      return i(
        ...
        function () {
          for (var n = 0; t.length > n; ) {
            if (t[n][0].apply(this, arguments))
              return t[n][1].apply(this, arguments);
            n += 1;
          }
        },
      );
    ...
    Tn = e(function (t, n) {
      ...
      return 0 === t
        ...
        : pn(
            cn(t, function (t, r, e, u, i, o, c, a, s, f) {
              switch (arguments.length) {
                case 1:
                  return new n(t);
                case 2:
  ...
  ((X.prototype["@@transducer/init"] = Ot.init),
    (X.prototype["@@transducer/result"] = function (t) {
      var n;
      for (n in this.inputs)
        if (
          w(n, this.inputs) &&
          (t = this.xf["@@transducer/step"](t, this.inputs[n]))[
            "@@transducer/reduced"
          ]
        ) {
    ...
    (X.prototype["@@transducer/step"] = function (t, n) {
      var r = this.keyFn(n);
      return (
        (this.inputs[r] = this.inputs[r] || [r, this.valueAcc]),
        (this.inputs[r][1] = this.valueFn(this.inputs[r][1], n)),
        t
      );
    }));
  var Un = o(
    ...
    Kn = e(function (t, n) {
      for (var r = [], e = 0, u = t.length; u > e; )
        (M(t[e], n) || M(t[e], r) || (r[r.length] = t[e]), (e += 1));
      return r;
    }),
    Vn = c(function (t, n, r) {
      for (var e = [], u = 0, i = n.length; i > u; )
        (F(t, n[u], r) || F(t, n[u], e) || e.push(n[u]), (u += 1));
      return e;
    }),
    $n = e(function (t, n) {
      var r = {};
  ...
  ((Y.prototype["@@transducer/init"] = Ot.init),
    (Y.prototype["@@transducer/result"] = Ot.result),
    (Y.prototype["@@transducer/step"] = function (t, n) {
      return this.n > 0
        ? ((this.n -= 1), t)
        : this.xf["@@transducer/step"](t, n);
    }));
  var Zn = e(
    s(
      ["drop"],
  ...
  ((Z.prototype["@@transducer/init"] = Ot.init),
    (Z.prototype["@@transducer/result"] = Ot.result),
    (Z.prototype["@@transducer/step"] = function (t, n) {
      this.i += 1;
  ...
  ((G.prototype["@@transducer/init"] = Ot.init),
    (G.prototype["@@transducer/result"] = function (t) {
      return ((this.acc = null), this.xf["@@transducer/result"](t));
    }),
  ...
  ((Q.prototype["@@transducer/init"] = Ot.init),
    (Q.prototype["@@transducer/result"] = function (t) {
    ...
    (Q.prototype.flush = function (t, n) {
      return (
        (t = b(this.xf["@@transducer/step"], t, this.retained)),
        (this.retained = []),
        this.xf["@@transducer/step"](t, n)
      );
    }),
  ...
  ((tt.prototype["@@transducer/init"] = Ot.init),
    (tt.prototype["@@transducer/result"] = Ot.result),
    (tt.prototype["@@transducer/step"] = function (t, n) {
      var r = !1;
      return (
        this.seenFirstValue
          ? this.pred(this.lastValue, n) && (r = !0)
          : (this.seenFirstValue = !0),
        (this.lastValue = n),
        r ? t : this.xf["@@transducer/step"](t, n)
      );
    }));
  var nr = e(function (t, n) {
    ...
    ur = e(
      s([], nr, function (t, n) {
        ...
        if (0 !== u)
          for (r[0] = n[0]; u > e; )
            (t(er(r), n[e]) || (r[r.length] = n[e]), (e += 1));
        return r;
      }),
    ),
    ir = r(s([], nr(_n), ur(_n)));
  ((nt.prototype["@@transducer/init"] = Ot.init),
    (nt.prototype["@@transducer/result"] = Ot.result),
    (nt.prototype["@@transducer/step"] = function (t, n) {
      if (this.f) {
  ...
  ((rt.prototype["@@transducer/init"] = Ot.init),
    (rt.prototype["@@transducer/result"] = function (t) {
      return (
    ...
    (rt.prototype["@@transducer/step"] = function (t, n) {
      return (
        this.f(n) &&
          ((this.found = !0), (t = f(this.xf["@@transducer/step"](t, n)))),
        t
      );
    }));
  var dr = e(
  ...
  ((et.prototype["@@transducer/init"] = Ot.init),
    (et.prototype["@@transducer/result"] = function (t) {
      return (
    ...
    (et.prototype["@@transducer/step"] = function (t, n) {
      return (
        ...
        this.f(n) &&
          ((this.found = !0),
          (t = f(this.xf["@@transducer/step"](t, this.idx)))),
        t
      );
    }));
  var gr = e(
  ...
  ((ut.prototype["@@transducer/init"] = Ot.init),
    (ut.prototype["@@transducer/result"] = function (t) {
  ...
  ((it.prototype["@@transducer/init"] = Ot.init),
    (it.prototype["@@transducer/result"] = function (t) {
      return this.xf["@@transducer/result"](
  ...
  var mr = e(
    ...
    Tr = e(function (t, n) {
      return "function" != typeof n.indexOf || At(n)
        ? z(n, t, 0)
        : n.indexOf(t);
    }),
    Br = An(0, -1),
    ...
    Ur = c(function (t, n, r) {
      return (
        (t = r.length > t && t >= 0 ? t : r.length),
        [].concat(
          Array.prototype.slice.call(r, 0, t),
          n,
          Array.prototype.slice.call(r, t),
        )
      );
    });
  ...
  var Dr = e(function (t, n) {
      for (var r, e, u = new ct(), i = [], o = 0; n.length > o; )
    ...
    Mr = e(function (t, n) {
      var r, e;
      return (
        t.length > n.length ? ((r = t), (e = n)) : ((r = n), (e = t)),
        zr(V(xr(M)(r), e))
      );
    }),
    Lr = e(
      N("intersperse", function (t, n) {
        for (var r = [], e = 0, u = n.length; u > e; )
      ...
      "function" == typeof Object.assign
        ...
        : function (t) {
            ...
            for (var n = Object(t), r = 1, e = arguments.length; e > r; ) {
              var u = arguments[r];
              if (null != u) for (var i in u) w(i, u) && (n[i] = u[i]);
              r += 1;
            }
            return n;
          },
    ...
    Gr = e(function (t, n) {
      return xt(t + 1, function () {
        ...
        throw new TypeError(
          Wn(r) + ' does not have a method named "' + n + '"',
        );
      });
    }),
    Qr = e(function (t, n) {
    ...
    ru = e(function (t, n) {
      return xt(n.length, function () {
        ...
        return t.apply(
          this,
          r.concat(Array.prototype.slice.call(arguments, n.length)),
        );
      });
    }),
    eu = ru(p, [Ge, Ir]),
    ...
    Ou = e(function (t, n) {
      if (0 >= t)
        throw Error("First argument to splitEvery must be a positive integer");
  ...
  ((pt.prototype["@@transducer/init"] = Ot.init),
    (pt.prototype["@@transducer/result"] = Ot.result),
    (pt.prototype["@@transducer/step"] = function (t, n) {
  ...
  ((ht.prototype["@@transducer/init"] = Ot.init),
    (ht.prototype["@@transducer/result"] = Ot.result),
    (ht.prototype["@@transducer/step"] = function (t, n) {
  ...
  var Wu = e(
    ...
    Du = c(function (t, n, r) {
      return "function" == typeof r["fantasy-land/traverse"]
        ? r["fantasy-land/traverse"](n, t)
        : vu(t, Rt(n, r));
    }),
    zu = "\t\n\v\f\r   ᠎             　\u2028\u2029\ufeff",
    Mu = r(
      !("function" == typeof String.prototype.trim) || zu.trim()
        ? function (t) {
            var n = RegExp("^[" + zu + "][" + zu + "]*"),
              r = RegExp("[" + zu + "][" + zu + "]*$");
    ...
    $u = e(function (t, n) {
      return xt(t, function () {
        for (var r, e = 1, u = n, i = 0; t >= e && "function" == typeof u; )
          ((r = e === t ? arguments.length : i + u.length),
            (u = u.apply(this, Array.prototype.slice.call(arguments, i, r))),
            (e += 1),
            (i = r));
        return u;
      });
    ...
    ui = e(function (t, n) {
      for (var r in t) if (w(r, t) && !t[r](n[r])) return !1;
      return !0;
    }),
    ii = e(function (t, n) {
      return ui(Rt(_n, t), n);
  ...
  ((t.F = gt),
    ...
    (t.composeP = function () {
      if (0 === arguments.length)
        throw Error("composeP requires at least one argument");
    ...
    (t.pipeK = function () {
      if (0 === arguments.length)
        throw Error("pipeK requires at least one argument");
    ...
    (t.subtract = _u),
    (t.sum = me),
    (t.symmetricDifference = qu),
    (t.symmetricDifferenceWith = ku),
    (t.tail = On),
    (t.take = Gn),
    (t.takeLast = fr),
    (t.takeLastWhile = Nu),
